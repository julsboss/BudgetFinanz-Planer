...
public class PasswordRO {
   ...
   /* public PasswordRO(String name, String value, String confirmationStatus, String source, SlotValue slotValue) {
        super();
        this.name = name;
        this.value = value;
    ...
    public PasswordRO(String name, String value) {
        super();
        this.name = name;
        this.value = value;
